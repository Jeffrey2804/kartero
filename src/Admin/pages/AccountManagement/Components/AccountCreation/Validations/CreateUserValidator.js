...
import { dateValidator, textValidator, emailValidator, passwordValidator, confirmPasswordValidator, phoneValidator } from "./Validators";
...
export const CreateUserValidator = (values) => {
    ...
    const validateForm = ({values, field, errors, forceTouchErrors = false}) => {
        ...
        if(nextErrors.userName.dirty && (field ? field === "userName" : true)){
            const userNameMessage = textValidator(userName, values);

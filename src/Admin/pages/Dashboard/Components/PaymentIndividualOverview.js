...
const headCells = [
    ...
    },
    {
        ...
        disablePadding: false,
        label: 'amountDue',
        format: (value) => value.toFixed(2).replace(/(\d)(?=(\d{3})+(?!\d))/g, '1,')
    },
    {
        id: 'amountCollected',
        numeric: false,
                ...
                <Paper sx={{ width: '100%', mb: 2 }}>
                 ...
                 paymentIndividualOverview.slice().sort(getComparator(order, orderBy)) */}
                                    {stableSort(paymentIndividualOverview, getComparator(order, orderBy))
                                        ...
                                        .map((row, index) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                {headCells.map((columns) => {
                                                    const test = row[columns.id];
                                                    return (
                                                        <TableCell align="left" key={columns.id}>

                                                        {columns.format && typeof test === 'number'
                                                            ? columns.format(test)
                                                            : test }
                          ...
                          /> */}
                                                    ...
                                                    <TableCell align="right">{row.amountCollected}</TableCell>

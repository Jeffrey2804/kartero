...
export default function AddGlobalVariableModal(props) {
    ...
    const createActiveSubscription = () => {
        ...
        globalVariablesService
            .createGlobalVariable(variable, user.merchantId)
            .then((response) => {
            ...
            <>
                ...
                <Grid item xs={6}>
                    <FormControl sx={{ minWidth: '300px' }}>
                        <InputLabel id="formatLabel">Select Accepted format</InputLabel>
                        <Select
                            labelId="formatLabel"
                            id="formatString"
        ...
        return (
            <>
                ...
                <Grid item xs={6}>
                    ...
                    <FormControl sx={{ minWidth: '300px' }}>
                        <InputLabel id="formatLabel">Select Output format</InputLabel>
                        <Select
                            labelId="formatLabel"
                            id="formatString"
                            value={variable.format}
    ...
    const showDate = () => {
        ...
        return (
            <>
                ...
                <Grid item xs={6}>
                    <FormControl sx={{ minWidth: '300px' }}>
                        <InputLabel id="formatLabel">Select Acceptable format</InputLabel>
                        <Select
                            labelId="formatLabel"
                            id="formatString"
                            value={variable.format}
    ...
    useEffect(() => {
        ...
        if (props.showModal == true) {
            handleOpen();
            setVariable({ ...variable, ["type"]: "String" });
            return;
        } else {
            handleClose();
            return

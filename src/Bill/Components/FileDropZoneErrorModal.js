...
export default function FileDropZoneErrorModal(props) {
                    ...
                    <Fade in={open}>
                        <Box sx={style}>
                            ...
                            <div className='mb-5 text-center' >
                                <FileDropZoneErrorMessage steps={props.steps} />
                            </div>
                            <Stack spacing={2} direction="column" alignItems="center">
                                <Button variant="contained" 
                                sx={{borderRadius: 20, marginBottom: 3, fontSize: 15, fontWeight: 500}}

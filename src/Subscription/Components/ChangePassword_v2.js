...
function ChangePassword() {
    ...
    return (
        <div className='changePassword grid justify-center mt-20'>

            <div>
                <TableContainer sx={{ minWidth: 500, width: '80vw', border: 1, borderRadius: 4 }}>
                        ...
                        <TableBody style={{ cursor: 'pointer' }}>
                            ...
                            <div className='ml-48 pt-8'>
                                <div class="grid grid-cols-2 gap-4 lg:gap-8">
                                    <div class="h-20 rounded-lg pt-5">
                                ...
                                <div class="grid grid-cols-2 gap-4  lg:gap-8">
                                    <div class="h-20 rounded-lg pt-5">
                                        ...
                                        <div className='titleHolder align-middle'>Old Password </div>
                                    </div>
                                    <div class="h-20 rounded-lg ">
                ...
                <div class="grid justify-center m-5">
                    <div className='grid justify-items-center text-base rounded-full p-1 w-28 mt-8 transition ease-in-out bg-yellow-orange hover:bg-dark-yellow-orange text-white font-light cursor-pointer'>
